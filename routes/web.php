...
Route::group(['middleware' => ['auth', 'checklevel:admin']], function () {
    ...
    Route::get('/admin/peminjaman/{id}', 'PeminjamanController@namaMetode')->name('admin.peminjaman');
...
Route::group(['middleware' => ['auth', 'checklevel:user']], function () {
    ...
    Route::get('/landing/AktivitasMahasiswa', [LandingController::class, 'AktivitasMahasiswa'])->name('landing.AktivitasMahasiswa');
});
