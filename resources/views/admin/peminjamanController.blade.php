...
<body>
    ...
    <div class="container">
        <div class="row mt-3">
            <div class="col">
                <!-- Assuming you have user authentication, display the user's name here -->
            ...
            <nav class="navbar navbar-expand-lg">
                <div class="collapse navbar-collapse" id="navbarNav">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item" style="margin-left: 30px">
                            <h5>
                                <a class="nav-link active" aria-current="page" href="{{ route('admin.peminjaman', ['id' => 1]) }}">Peminjaman</a>
                            </h5>
                        </li>
                    </ul>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-center">
                        <!-- Display a chart here if you have implemented it -->
                        {!! $chart->container() !!}
                    </div>
                </div>
            </div>
        ...
        <div class="row mt-5">
            <!-- Display a "Cetak Data" button for printing data -->
            <div class="col">
            ...
            <!-- Display a "Tambah Data" button to add data -->
            <div class="col-2">
        ...
        <table class="table" style="margin-top: 10px">
            ...
            <tbody class="table-group-divider">
                ...
                <tr>
                    ...
                    <td>
                        <!-- Display status with different styles based on condition -->
                        <span class="{{ $peminjam->status === 'Sudah Dikembalikan' ? 'fw-semibold text-success' : 'fw-semibold text-danger' }}">
                            {{ $peminjam->status }}
                        </span>
                    </td>
                    <td>
                        <a class="btn btn-outline-primary" href="{{ route('admin.detailPeminjaman', ['id' => $peminjam->id, 'id_user' => $peminjam->id_user, 'id_buku' => $peminjam->id_buku]) }}">Detail</a>
                        <a class="btn btn-outline-warning" href="{{ route('admin.editPeminjaman', ['id' => $peminjam->id]) }}">Edit</a>
                        <a class="btn btn-outline-danger" href="{{ route('admin.deletePeminjaman', ['id' => $peminjam->id]) }}">Delete</a>
                    </td>
                </tr>
                @endforeach
            </tbody>
        ...
        <!-- Include Chart.js script, if needed -->
